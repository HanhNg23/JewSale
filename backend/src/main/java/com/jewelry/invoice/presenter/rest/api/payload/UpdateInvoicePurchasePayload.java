...
import com.jewelry.invoice.presenter.rest.api.dto.InvoiceItemBuyBackDto;
...
@Data
public class UpdateInvoicePurchasePayload {
	
	@NotNull(message = "Invoice id of the original invoice cannot be null")
	@Schema(description = "The invoice id of the original invoice want to update")
	private Integer invoiceId;
	
	@NotNull(message = "Transaction Type is required SELL OR PURCHASE")
    @Schema(description = "Type of the transaction: bán ra, mua vào", example = "PURCHASE")
    ...
    @Valid
    private List<InvoiceItemBuyBackDto> invoiceItems;
