...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JewelryApis.MetalPriceCreateDto();
  });
  ...
  describe('MetalPriceCreateDto', function() {
    it('should create an instance of MetalPriceCreateDto', function() {
      // uncomment below and update the code to test MetalPriceCreateDto
      //var instance = new JewelryApis.MetalPriceCreateDto();
      //expect(instance).to.be.a(JewelryApis.MetalPriceCreateDto);
    });
