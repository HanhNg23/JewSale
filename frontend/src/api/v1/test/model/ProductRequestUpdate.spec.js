...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JewelryApis.ProductRequestUpdate();
  });
  ...
  describe('ProductRequestUpdate', function() {
    it('should create an instance of ProductRequestUpdate', function() {
      // uncomment below and update the code to test ProductRequestUpdate
      //var instance = new JewelryApis.ProductRequestUpdate();
      //expect(instance).to.be.a(JewelryApis.ProductRequestUpdate);
    });
