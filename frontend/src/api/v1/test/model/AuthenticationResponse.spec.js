...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JewelryApis.AuthenticationResponse();
  });
  ...
  describe('AuthenticationResponse', function() {
    it('should create an instance of AuthenticationResponse', function() {
      ...
      //var instance = new JewelryApis.AuthenticationResponse();
      //expect(instance).to.be.a(JewelryApis.AuthenticationResponse);
    });
